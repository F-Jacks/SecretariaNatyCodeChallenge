...
export const videoSrc = "https://digitalassets.tesla.com/tesla-contents/video/upload/f_auto,q_auto/Homepage-Test_Drive-NA-Desktop.mp4";
export const clientLink = {link: "/sign/rider", text: "Im Client"};
export const driverLink = {link: "/sign/driver", text: "Im Driver"};
export const continueReadingText = "our service";
export const continueReadingIcon = "🡇";